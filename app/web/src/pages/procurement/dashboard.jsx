...
function ProcurementOverview({ nav }) {
    ...
    const cards = [
        ...
        { label: "Awaiting Receipt",  value: stats?.awaiting_receipt ?? 0,   icon: "truck",  color: "#f59e0b" },
    ...
    return (<>
        ...
        <div className="pr-grid2">
            <div className="pr-card" style={{ marginBottom: 0 }}>
                ...
                {orders.length > 0 ? (
                    <div className="pr-tblwrap" style={{ border: "none" }}>
                        <table className="pr-tbl">
                            <thead><tr><th>PO</th><th>Vendor</th><th className="pr-tbl-r">Total</th><th>Status</th></tr></thead>
                            <tbody>
                ...
                ) : <Empty icon="cart" title="No purchase orders yet" desc="Raise a requisition or create a PO to get started." action="New PO" onAction={() => nav("/procurement/orders")} />}
            </div>
            ...
            <div className="pr-card" style={{ marginBottom: 0 }}>
                ...
                {pending.length > 0 ? (
                    <div className="pr-tblwrap" style={{ border: "none" }}>
                        <table className="pr-tbl">
                            <thead><tr><th>PO</th><th>Vendor</th><th className="pr-tbl-r">Next step</th></tr></thead>
                            <tbody>
            ...
            <div className="pr-head">
                <div className="pr-head-l">
                    ...
                    <div>
                        ...
                        <p className="pr-sub">Requisitions, purchase orders, goods receipt and vendor bills</p>
                    </div>
                </div>
            </div>
